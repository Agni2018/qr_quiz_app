...
export default function QuizPlay({ params }: { params: Promise<{ topicId: string }> }) {
    ...
    useEffect(() => {
        ...
        // 2. Fetch Questions
        axios.get(`http://localhost:5000/api/questions/topic/${topicId}`)
            .then(res => {
                    ...
                    <Card style={{ padding: '2rem', minHeight: '400px', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '2rem' }}>
                            ...
                            <Button
                                ...
                                disabled={!currentAnswer && currentAnswer !== false} // Require answer to proceed? Making it required for now.
                            >
